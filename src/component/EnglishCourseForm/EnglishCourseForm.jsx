...
export default function EnglishCoursePriceForm() {
  ...
  return (
    <>
      {/* Thank You Popup */}
      {showThankYou && (
        <div className="fixed inset-0 bg-[#050505da] bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg max-w-md w-full p-6 text-center">
            ...
            <p className="text-gray-600 mb-6">
              Thank you for submitting your information. One of our team members will contact you shortly with your personalized English course price.
            </p>
            <button
              onClick={closeThankYou}
              className="bg-[#003366] hover:bg-[#002244] text-white font-semibold px-6 py-2 rounded-sm transition-colors"
            >
              Close
            </button>
          </div>
